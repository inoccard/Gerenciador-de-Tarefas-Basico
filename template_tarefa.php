	...
	<body>
		...
		<?php if (count($anexos) > 0) : ?>
			<table border="2" style="border-radius: 8px">
				...
				<tr>
					<td style="padding-right: 1em; padding-left: 1em"><?php echo $anexo['nome']; ?></td>
		...
		<!-- multipart/form-data indica para o navegador que nosso formulário irá fazer o envio de arquivos -->
		<form action="" method="POST" enctype="multipart/form-data">
			<fieldset>
				<legend>Novo Anexo</legend>
				<input type="hidden" name="tarefa_id" value="<?php echo $tarefa['idtarefas']; ?>"/>
				<label>
